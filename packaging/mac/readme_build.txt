...
1. Install clean Python 3.12 into default Framework folder.
2. (If you want to bundle some 3rd party libraries, then pip-install these here)
3. Run prepare_base_bundle.sh. This will copy Python into ~/thonny_template_build_312
	using the copy_python_framework.sh script and prepare most of the application
        bundle. It also relinks the binaries to make them relocatable.
...
4. Run create_release.sh. This will pip-install newest Thonny into the Python 
	copied into ~/thonny_template_build_312 and create distribution packages under dist.
